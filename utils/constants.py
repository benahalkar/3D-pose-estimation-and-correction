...
File contains constants for use throughout the application.
...
class Constants(Enum):
    """
    Enum class to hold constant values used throughout the application.
    """
    ...
    """
    Dictionary mapping body keypoint names to their corresponding indices
    as defined by MediaPipe Pose Landmarker.
    """
    ...
    """
    Dictionary mapping integer identifiers to yoga pose names.
    """
    ...
    """
    Dictionary defining ground truth angle values for various yoga poses.
    These values are used for pose correction and feedback.
    """
    ...
    """
    Dictionary to store landmark coordinates during pose estimation.
    Initialized with empty lists for each landmark.
    """
    ...
    """
    Dictionary containing personalized feedback messages for each yoga pose
    and specific body parts.  These messages are displayed to the user
    to help them correct their pose.
    """
